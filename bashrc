...
export PATH JAVA_VERSION JAVA_HOME JAVA_PATH JDK_HOME CATALINA_HOME ANT_HOME HISTIGNORE HISTSIZE HISTCONTROL HISTFILE PROMPT_COMMAND LESS CDPATH MYSQL_PS1 MYSQL_HOST HISTTIMEFORMAT TL EDITOR VIMHOME LOCATE_PATH PYTHONPATH SSLKEYLOGFILE DEPOT_TOOLS GOPATH
